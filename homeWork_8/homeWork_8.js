...
/*
 ...
 Пример:
   createDivWithText('hello') // создаст элемент div, поместит в него 'hello' и вернет созданный элемент
 */
...
/*
 ...
 Пример:
   ...
   findError(document.body) // функция должна вернуть массив с элементами 'привет' и 'hello'
 */
...
/*
 ...
 Пример:
   Для дерева <div class="some-class-1"><b>привет!</b> <b class="some-class-1 some-class-2">hello</b></div>
